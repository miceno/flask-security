...
_default_config = {
    ...
    'RESET_REDIRECT_URL': None,  # non-form based password reset API
    # LINK_HOST: Useful to specify host:port for email links for testing where UI and backend are separate
    'LINK_HOST': None,
